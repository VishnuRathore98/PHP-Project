...
<head>
 ...
 <div class="admintitle" align="center">
   <h1>Delete the Student Information</h1>
  </div>
...
<table align="center" border="1" style="width:50%; margin-top:40px">
	...
	<input type="submit"   align="center" id="right-label" name="submit" value="Submit" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
       
	<input type="submit"   align="center" id="right-label" name="delete" value="Delete Record" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 ...
 if(isset($_REQUEST['delete']))
	{
	  $rollno=$_REQUEST['rollno'];
       	  if(mysqli_query($con,"delete from student where rollno ='$rollno'  "))
